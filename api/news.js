...
export default async function handler(req) {
  ...
  try {
    ...
    const news = (data||[]).slice(0,10).map(n => ({ id:n.id, headline:n.headline, summary:n.summary, source:n.source, url:n.url, image:n.image||'', datetime:n.datetime, category:n.category }));
